            ...
            <div className="relative z-10 flex shrink-0 flex-nowrap items-center gap-2 sm:gap-3">
              ...
              <Drawer open={drawerOpen} onOpenChange={setDrawerOpen}>
                <DrawerTrigger asChild>
                  <button
                    type="button"
                    className="group relative flex shrink-0 items-center gap-2 rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm font-medium text-slate-700 shadow-sm transition-all hover:border-slate-300 hover:bg-slate-50 sm:px-4 sm:py-2.5"
                  >
                    <i className="fas fa-id-card text-slate-500 group-hover:text-blue-500"></i>
              ...
              <button
                ...
                className="group relative flex shrink-0 items-center gap-2 rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm font-medium text-slate-700 shadow-sm transition-all hover:border-slate-300 hover:bg-slate-50 sm:px-4 sm:py-2.5"
              >
                <i className="fas fa-print text-slate-500 group-hover:text-blue-500"></i>
                <span className="hidden md:inline">Print Profile</span>
                {/* Tooltip */}
