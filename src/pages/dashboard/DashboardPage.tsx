            ...
            <div className="p-4">
              <div className="space-y-2">
                <a
                  ...
                  className="group flex items-center gap-3 rounded-xl p-3 transition-all duration-200 hover:bg-blue-50"
                >
                ...
                <a
                  ...
                  className="group flex items-center gap-3 rounded-xl p-3 transition-all duration-200 hover:bg-amber-50"
                >
                ...
                <a
                  ...
                  className="group flex items-center gap-3 rounded-xl p-3 transition-all duration-200 hover:bg-emerald-50"
                >
